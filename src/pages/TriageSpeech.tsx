        ...
        <div className="min-h-screen bg-[var(--color-bg-base)] pt-32 pb-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-50 border border-teal-200 mb-5">
                        <Mic className="w-5 h-5 text-[var(--color-teal-accent)]" />
                        <span className="text-sm font-semibold text-[var(--color-teal-accent)] tracking-wide">AI Voice Analysis</span>
                    </div>
                    <h1 className="text-4xl font-extrabold text-gray-900 mb-3">Speak your symptoms</h1>
                    <p className="text-lg text-gray-500">Tap the mic and speak naturally. Our AI listens and detects your symptoms in real time.</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="flex flex-col gap-6">
                        {/* Mic Card */}
                        <div className={`bg-white border-2 rounded-[2rem] shadow-xl p-8 flex flex-col items-center transition-all duration-500 ${isListening ? 'border-teal-400 shadow-teal-200/60 shadow-2xl' : 'border-gray-100'
                            }`}>
                            {/* Status label */}
                        ...
                        {/* Transcript */}
                        <div className="bg-white border border-gray-100 rounded-[2rem] shadow-lg p-6">
                        ...
                        {detectedSymptoms.length > 0 && (
                            <div className="bg-teal-50 border-2 border-teal-200 rounded-[2rem] p-6">
                                <div className="flex items-center gap-2 mb-4">
                                    <Activity className="w-5 h-5 text-[var(--color-teal-accent)]" />
                                    <h3 className="font-bold text-teal-800">Detected Symptoms</h3>
                                </div>
                        ...
                        <button
                            ...
                            onClick={() => console.log('Analyzing:', { transcript, detectedSymptoms })}
                            className="w-full py-5 bg-gradient-auth text-white text-xl font-extrabold rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Analyze Risk
                    ...
                    <div className="hidden lg:flex flex-col gap-6">
                        {/* Doctor Illustration */}
                        <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-100 rounded-[2.5rem] p-8 shadow-lg flex flex-col items-center text-center">
                            ...
                            <div className="animate-float mb-6">
                                <div className="relative w-64 h-64 rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                                    <img
                                        src={isListening
                                            ? "https://imgs.search.brave.com/IPiK7cuyiVnALmYh-nEkbAUkzCyNlja77s6oH0LKZoI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvMTM3/NTE0MzE0Ny9waG90/by9zZXJpb3VzLW1h/bGUtZG9jdG9yLWxp/c3RlbnMtdG8tdW5y/ZWNvZ25pemFibGUt/d29tYW4uanBnP3M9/NjEyeDYxMiZ3PTAm/az0yMCZjPVpKNUdq/dzNMZ3pIQTAzRGox/UFRtd2VzVEpqOVFP/aXRER21SY2V4cDdo/bE09"
                                            : "https://imgs.search.brave.com/JrtbmPC4leY620-doVDaOCIsjF1Ly29mQmhoG5yq8Xk/rs:fit:860:0:0:0/g:"
                                        }
